...
var knownTStatusCodeValues = []TStatusCode{
	TStatusCode_OK,
	TStatusCode_CANCELLED,
	TStatusCode_ANALYSIS_ERROR,
	TStatusCode_NOT_IMPLEMENTED_ERROR,
	TStatusCode_RUNTIME_ERROR,
	TStatusCode_MEM_LIMIT_EXCEEDED,
	TStatusCode_INTERNAL_ERROR,
}
