...
import (
	...
	"strings"
	"regexp"
	"github.com/jasonlabz/go-impala/services/status"
...
var knownTImpalaQueryOptionsValues = []TImpalaQueryOptions{
	TImpalaQueryOptions_ABORT_ON_ERROR,
	TImpalaQueryOptions_MAX_ERRORS,
	TImpalaQueryOptions_DISABLE_CODEGEN,
	TImpalaQueryOptions_BATCH_SIZE,
	TImpalaQueryOptions_MEM_LIMIT,
	TImpalaQueryOptions_NUM_NODES,
	TImpalaQueryOptions_MAX_SCAN_RANGE_LENGTH,
	TImpalaQueryOptions_MAX_IO_BUFFERS,
	TImpalaQueryOptions_NUM_SCANNER_THREADS,
	TImpalaQueryOptions_ALLOW_UNSUPPORTED_FORMATS,
	TImpalaQueryOptions_DEFAULT_ORDER_BY_LIMIT,
	TImpalaQueryOptions_DEBUG_ACTION,
}

func TImpalaQueryOptionsValues() iter.Seq[TImpalaQueryOptions] {
	return func(yield func(TImpalaQueryOptions) bool) {
		for _, v := range knownTImpalaQueryOptionsValues {
			if !yield(v) {
				return
			}
		}
